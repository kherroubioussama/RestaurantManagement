                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex flex-row justify-content-between align-items-center border-bottom pb-1">
                                                <h3 class="text-secondary">
                                                    <i class="fas fa-file-alt"></i> Rapport des ventes
                                                </h3>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-sm-4 shadow mx-auto p-2">
                                        ...
                                        <tbody>
                                            @foreach ($sales as $sale)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $sale->paiment_type === "cash" ? "Espéce" : "Carte bancaire"}}
                                                    </td>
                                                    <td>
                                                        {{ $sale->paiment_status === "paid" ? "Payé" : "Impayé"}}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
