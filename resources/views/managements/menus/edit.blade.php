                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <form action="{{route("menus.update",$menu->slug)}}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <textarea name="description" id="description" class="form-control" cols="30" rows="5" placeholder="Description">{{$menu->description}}</textarea>
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="number" name="price" id="price" class="form-control" placeholder="Prix" value="{{$menu->price}}">
                                                ...
                                                <div class="form-group">
                                                    <select name="category_id" class="form-control">
                                                        ...
                                                        <option {{$category->id === $menu->category->id ? "selected":""}} value="{{$category->id}}">{{$category->title}}</option>
                                                        @endforeach
                                                    </select>
